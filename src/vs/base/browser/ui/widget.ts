...
export abstract class Widget extends Disposable {
	protected onclick(
		...
		this._register(
			DomUtils.addDisposableListener(
				...
				(e: MouseEvent) => listener(new StandardMouseEvent(e))
			)
		);
	}
	...
	protected onmouseover(
		...
		this._register(
			DomUtils.addDisposableListener(
				domNode,
				DomUtils.EventType.MOUSE_OVER,
				(e: MouseEvent) => listener(new StandardMouseEvent(e))
			)
		);
	}

	protected onnonbubblingmouseout(
		domNode: HTMLElement,
		listener: (e: IMouseEvent) => void
	): void {
		this._register(
	...
	protected onkeydown(
		...
		this._register(
			DomUtils.addDisposableListener(
				domNode,
				DomUtils.EventType.KEY_DOWN,
				(e: KeyboardEvent) => listener(new StandardKeyboardEvent(e))
			)
		);
	}
	...
	protected onblur(domNode: HTMLElement, listener: (e: Event) => void): void {
		this._register(
			DomUtils.addDisposableListener(domNode, DomUtils.EventType.BLUR, listener)
		);
	}
