...
import {
	...
	WholeWordsCheckbox,
	RegexCheckbox
} from 'vs/base/browser/ui/findinput/findInputCheckboxes';
...
export class FindInput extends Widget {
	...
	public onDidOptionChange: Event<boolean> /* via keyboard */ = this
		._onDidOptionChange.event;
	...
	public onCaseSensitiveKeyDown: Event<IKeyboardEvent> = this
		._onCaseSensitiveKeyDown.event;
	...
	constructor(
		...
		this.inputValidationWarningBackground =
			options.inputValidationWarningBackground;
		this.inputValidationErrorBorder = options.inputValidationErrorBorder;
		this.inputValidationErrorBackground =
			options.inputValidationErrorBackground;
		...
		this.buildDomNode(
			options.appendCaseSensitiveLabel || '',
			options.appendWholeWordsLabel || '',
			options.appendRegexLabel || ''
		);
	...
	private setInputWidth(): void {
		let w =
			this.width -
			this.caseSensitive.width() -
			this.wholeWords.width() -
			this.regex.width();
	...
	private buildDomNode(
		...
		this.inputBox = this._register(
			new InputBox(this.domNode, this.contextViewProvider, {
