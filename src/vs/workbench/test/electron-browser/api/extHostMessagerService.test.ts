...
suite('ExtHostMessageService', function() {
	test('propagte handle on select', function() {
		let service = new MainThreadMessageService(
			<any>{
	...
	test('isCloseAffordance', function() {
		...
		service.$showMessage(1, '', {}, [
			{ title: 'a thing', isCloseAffordance: false, handle: 0 }
		]);
		...
		service.$showMessage(1, '', {}, [
			{ title: 'a thing', isCloseAffordance: true, handle: 0 }
		]);
