...
export class RangeHighlightDecorations implements IDisposable {
	...
	public readonly onHighlghtRemoved: Event<void> = this._onHighlightRemoved
		.event;
	...
	public highlightRange(
		range: IRangeHighlightDecoration,
	...
	private getEditor(
		...
		if (fileResource) {
			if (isEqual(fileResource.fsPath, resourceRange.resource.fsPath)) {
				return <editorCommon.ICommonCodeEditor>this.editorService
					.getActiveEditor()
					.getControl();
			}
		}
