...
export type IWorkbenchContributionSignature = IConstructorSignature0<
...
class WorkbenchContributionsRegistry extends BaseRegistry<
	IWorkbenchContribution
> implements IWorkbenchContributionsRegistry {
	public registerWorkbenchContribution(
	...
	public setWorkbenchContributions(
		contributions: IWorkbenchContribution[]
	): void {
