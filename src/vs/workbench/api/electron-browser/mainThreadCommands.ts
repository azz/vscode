...
export class MainThreadCommands extends MainThreadCommandsShape {
	...
	$registerCommand(id: string): TPromise<any> {
		this._disposables[
			...
			this._proxy.$executeContributedCommand(id, ...args)
		);
		return undefined;
	}
...
CommandsRegistry.registerCommand('_generateCommandsDocumentation', function(
	accessor
) {
	return accessor
		.get(IThreadService)
		.get(ExtHostContext.ExtHostCommands)
