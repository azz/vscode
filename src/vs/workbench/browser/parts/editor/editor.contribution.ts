...
import {
	...
	StatusbarAlignment,
	IStatusbarRegistry,
	Extensions as StatusExtensions
...
class UntitledEditorInputFactory implements IEditorInputFactory {
	...
	public deserialize(
		...
		return instantiationService.invokeFunction<
			UntitledEditorInput
		>(accessor => {
			const deserialized: ISerializedUntitledEditorInput = JSON.parse(
				serializedEditorInput
			);
			const resource = !!deserialized.resourceJSON
				? URI.revive(deserialized.resourceJSON)
			...
			return accessor.get(IWorkbenchEditorService).createInput({
				resource,
				filePath,
				language,
				encoding
			}) as UntitledEditorInput;
		});
	}
}
...
class SideBySideEditorInputFactory implements IEditorInputFactory {
	public serialize(editorInput: EditorInput): string {
		...
		if (input.details && input.master) {
			...
			const detailsInputFactory = registry.getEditorInputFactory(
				input.details.getTypeId()
			);
			const masterInputFactory = registry.getEditorInputFactory(
				input.master.getTypeId()
			);
			...
			if (detailsInputFactory && masterInputFactory) {
				...
				if (detailsSerialized && masterSerialized) {
					return JSON.stringify(
						<ISerializedSideBySideEditorInput>{
							name: input.getName(),
	...
	public deserialize(
		...
		const registry = Registry.as<IEditorRegistry>(EditorExtensions.Editors);
		const detailsInputFactory = registry.getEditorInputFactory(
			deserialized.detailsTypeId
		);
		const masterInputFactory = registry.getEditorInputFactory(
			deserialized.masterTypeId
		);

		if (detailsInputFactory && masterInputFactory) {
			const detailsInput = detailsInputFactory.deserialize(
				instantiationService,
				deserialized.detailsSerialized
			);
			const masterInput = masterInputFactory.deserialize(
				instantiationService,
				deserialized.masterSerialized
			);
...
Registry.as<IEditorRegistry>(
	...
	SideBySideEditorInputFactory
);

// Register Editor Status
const statusBar = Registry.as<IStatusbarRegistry>(StatusExtensions.Statusbar);
statusBar.registerStatusbarItem(
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ChangeModeAction,
		ChangeModeAction.ID,
		ChangeModeAction.LABEL,
		{ primary: KeyChord(KeyMod.CtrlCmd | KeyCode.KEY_K, KeyCode.KEY_M) }
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ChangeEncodingAction,
		ChangeEncodingAction.ID,
		ChangeEncodingAction.LABEL
	),
	...
	public getActions(context: any): IAction[] {
		...
		if (entry) {
			if (!this.openToSideActionInstance) {
				this.openToSideActionInstance = this.instantiationService.createInstance(
					OpenToSideAction
				);
			} else {
...
Registry.as<IQuickOpenRegistry>(
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenNextEditorInGroup,
		OpenNextEditorInGroup.ID,
		OpenNextEditorInGroup.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenPreviousEditorInGroup,
		OpenPreviousEditorInGroup.ID,
		OpenPreviousEditorInGroup.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenNextRecentlyUsedEditorAction,
		OpenNextRecentlyUsedEditorAction.ID,
		OpenNextRecentlyUsedEditorAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenPreviousRecentlyUsedEditorAction,
		OpenPreviousRecentlyUsedEditorAction.ID,
		OpenPreviousRecentlyUsedEditorAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		OpenNextRecentlyUsedEditorInGroupAction.LABEL,
		{
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		OpenPreviousRecentlyUsedEditorInGroupAction.LABEL,
		{
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ShowAllEditorsAction,
		ShowAllEditorsAction.ID,
		ShowAllEditorsAction.LABEL,
		{
			primary: KeyChord(
				KeyMod.CtrlCmd | KeyCode.KEY_K,
				KeyMod.CtrlCmd | KeyCode.KEY_P
			),
			mac: { primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.Tab }
		}
	),
	'View: Show All Editors',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ShowEditorsInGroupOneAction,
		ShowEditorsInGroupOneAction.ID,
		ShowEditorsInGroupOneAction.LABEL
	),
	'View: Show Editors in First Group',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ShowEditorsInGroupTwoAction,
		ShowEditorsInGroupTwoAction.ID,
		ShowEditorsInGroupTwoAction.LABEL
	),
	'View: Show Editors in Second Group',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ShowEditorsInGroupThreeAction,
		ShowEditorsInGroupThreeAction.ID,
		ShowEditorsInGroupThreeAction.LABEL
	),
	'View: Show Editors in Third Group',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ReopenClosedEditorAction,
		ReopenClosedEditorAction.ID,
		ReopenClosedEditorAction.LABEL,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		ClearRecentFilesAction.LABEL
	),
	'View: Clear Recent Files',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		CloseAllEditorsAction,
		CloseAllEditorsAction.ID,
		CloseAllEditorsAction.LABEL,
		{
			primary: KeyChord(
				KeyMod.CtrlCmd | KeyCode.KEY_K,
				KeyMod.CtrlCmd | KeyCode.KEY_W
			)
		}
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		CloseLeftEditorsInGroupAction,
		CloseLeftEditorsInGroupAction.ID,
		CloseLeftEditorsInGroupAction.LABEL
	),
	'View: Close Editors to the Left',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		CloseRightEditorsInGroupAction.LABEL
	),
	'View: Close Editors to the Right',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		CloseEditorsInGroupAction.LABEL,
...
registry.registerWorkbenchAction(
	...
	'View: Close Other Editors',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		CloseEditorsInOtherGroupsAction,
		CloseEditorsInOtherGroupsAction.ID,
		CloseEditorsInOtherGroupsAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		JoinTwoGroupsAction,
		JoinTwoGroupsAction.ID,
		JoinTwoGroupsAction.LABEL
	),
	'View: Join Editors of Two Groups',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		NavigateBetweenGroupsAction,
		NavigateBetweenGroupsAction.ID,
		NavigateBetweenGroupsAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		FocusFirstGroupAction.LABEL,
		{ primary: KeyMod.CtrlCmd | KeyCode.KEY_1 }
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		FocusSecondGroupAction.LABEL,
		{ primary: KeyMod.CtrlCmd | KeyCode.KEY_2 }
	),
	'View: Focus Second Editor Group',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		FocusThirdGroupAction.LABEL,
		{ primary: KeyMod.CtrlCmd | KeyCode.KEY_3 }
	),
	'View: Focus Third Editor Group',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		FocusLastEditorInStackAction,
		FocusLastEditorInStackAction.ID,
		FocusLastEditorInStackAction.LABEL,
		{
			primary: KeyMod.Alt | KeyCode.KEY_0,
			mac: { primary: KeyMod.WinCtrl | KeyCode.KEY_0 }
		}
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		EvenGroupWidthsAction,
		EvenGroupWidthsAction.ID,
		EvenGroupWidthsAction.LABEL
	),
	'View: Even Editor Group Widths',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MaximizeGroupAction,
		MaximizeGroupAction.ID,
		MaximizeGroupAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MinimizeOtherGroupsAction,
		MinimizeOtherGroupsAction.ID,
		MinimizeOtherGroupsAction.LABEL
	),
	'View: Minimize Other Editor Groups',
	category
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		MoveEditorLeftInGroupAction.LABEL,
		{
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		MoveEditorRightInGroupAction.LABEL,
		{
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MoveGroupLeftAction,
		MoveGroupLeftAction.ID,
		MoveGroupLeftAction.LABEL,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MoveGroupRightAction,
		MoveGroupRightAction.ID,
		MoveGroupRightAction.LABEL,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MoveEditorToPreviousGroupAction,
		MoveEditorToPreviousGroupAction.ID,
		MoveEditorToPreviousGroupAction.LABEL,
		{
			primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.LeftArrow,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		MoveEditorToNextGroupAction,
		MoveEditorToNextGroupAction.ID,
		MoveEditorToNextGroupAction.LABEL,
		{
			primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.RightArrow,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		FocusPreviousGroup,
		FocusPreviousGroup.ID,
		FocusPreviousGroup.LABEL,
		{
			primary: KeyChord(
				KeyMod.CtrlCmd | KeyCode.KEY_K,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		NavigateForwardAction,
		NavigateForwardAction.ID,
		NavigateForwardAction.LABEL,
		{
			primary: null,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		NavigateBackwardsAction,
		NavigateBackwardsAction.ID,
		NavigateBackwardsAction.LABEL,
		{
			primary: null,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenPreviousEditorFromHistoryAction,
		OpenPreviousEditorFromHistoryAction.ID,
		OpenPreviousEditorFromHistoryAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		ClearEditorHistoryAction,
		ClearEditorHistoryAction.ID,
		ClearEditorHistoryAction.LABEL
	),
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		RevertAndCloseEditorAction,
		RevertAndCloseEditorAction.ID,
		RevertAndCloseEditorAction.LABEL
	),
