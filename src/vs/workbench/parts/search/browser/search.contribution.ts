...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	handler: accessor => {
		...
		viewletService
			.openViewlet(Constants.VIEWLET_ID, true)
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	when: ContextKeyExpr.and(
		Constants.SearchViewletVisibleKey,
		Constants.FirstMatchFocusKey
	),
	primary: KeyCode.UpArrow,
	handler: (accessor, args: any) => {
		const searchViewlet: SearchViewlet = <SearchViewlet>accessor
			.get(IViewletService)
			.getActiveViewlet();
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	handler: (accessor, args: any) => {
		...
		accessor
			.get(IInstantiationService)
			.createInstance(
				searchActions.ReplaceAllAction,
				tree,
				tree.getFocus(),
				searchViewlet
			)
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	when: ContextKeyExpr.and(
		Constants.SearchViewletVisibleKey,
		Constants.ReplaceInputBoxFocussedKey
	),
	primary: KeyCode.Escape,
	handler: (accessor, args: any) => {
		accessor
			.get(IInstantiationService)
			.createInstance(
				searchActions.CloseReplaceAction,
				Constants.CloseReplaceWidgetActionId,
				''
			)
			.run();
	}
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	when: ContextKeyExpr.and(
		Constants.SearchViewletVisibleKey,
		Constants.SearchInputBoxFocussedKey
	),
	...
	handler: (accessor, args: any) => {
		accessor
			.get(IInstantiationService)
			.createInstance(
				searchActions.ShowNextSearchTermAction,
				searchActions.ShowNextSearchTermAction.ID,
				''
			)
			.run();
	}
	...
	handler: (accessor, args: any) => {
		accessor
			...
			.createInstance(
				...
				searchActions.ShowPreviousSearchTermAction.ID,
				''
			)
			.run();
	}
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	handler: (accessor, args: any) => {
		accessor
			.get(IInstantiationService)
			.createInstance(
				searchActions.FocusNextInputAction,
				searchActions.FocusNextInputAction.ID,
				''
			)
			.run();
	}
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
	...
	when: ContextKeyExpr.and(
		Constants.SearchViewletVisibleKey,
		Constants.InputBoxFocussedKey,
		Constants.SearchInputBoxFocussedKey.toNegated()
	),
	primary: KeyCode.UpArrow,
	handler: (accessor, args: any) => {
		accessor
			.get(IInstantiationService)
			.createInstance(
				searchActions.FocusPreviousInputAction,
				searchActions.FocusPreviousInputAction.ID,
				''
			)
			.run();
	}
...
CommandsRegistry.registerCommand(
	searchActions.FindInFolderAction.ID,
	searchActions.findInFolderCommand
);
...
class ExplorerViewerActionContributor extends ActionBarContributor {
	...
	public getSecondaryActions(context: any): IAction[] {
		...
		if (this.hasSecondaryActions(context)) {
			...
			let action = this._instantiationService.createInstance(
				searchActions.FindInFolderAction,
...
const ACTION_LABEL = nls.localize(
	'showTriggerActions',
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		Constants.VIEWLET_ID,
		nls.localize('showSearchViewlet', 'Show Search'),
		{ primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyCode.KEY_F },
		Constants.SearchViewletVisibleKey.toNegated()
	),
	'View: Show Search',
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.FocusActiveEditorAction,
		Constants.FocusActiveEditorActionId,
		'',
		{ primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyCode.KEY_F },
		ContextKeyExpr.and(
			Constants.SearchViewletVisibleKey,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.FindInFilesAction,
		Constants.FindInFilesActionId,
		nls.localize('findInFiles', 'Find in Files'),
		{ primary: KeyMod.CtrlCmd | KeyMod.Shift | KeyCode.KEY_F },
		Constants.SearchInputBoxFocussedKey.toNegated()
	),
	'Find in Files'
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.FocusNextSearchResultAction,
		searchActions.FocusNextSearchResultAction.ID,
		searchActions.FocusNextSearchResultAction.LABEL,
		{ primary: KeyCode.F4 }
	),
	''
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.FocusPreviousSearchResultAction,
		searchActions.FocusPreviousSearchResultAction.ID,
		searchActions.FocusPreviousSearchResultAction.LABEL,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.ReplaceInFilesAction,
		searchActions.ReplaceInFilesAction.ID,
		searchActions.ReplaceInFilesAction.LABEL,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.ToggleCaseSensitiveAction,
		Constants.ToggleCaseSensitiveActionId,
		'',
		ToggleCaseSensitiveKeybinding,
		ContextKeyExpr.and(
			Constants.SearchViewletVisibleKey,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.ToggleWholeWordAction,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		searchActions.ToggleRegexAction,
		Constants.ToggleRegexActionId,
		'',
		ToggleRegexKeybinding,
		ContextKeyExpr.and(
			Constants.SearchViewletVisibleKey,
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(ShowAllSymbolsAction, ACTION_ID, ACTION_LABEL, {
...
const outputChannelRegistry = <IOutputChannelRegistry>Registry.as(
	OutputExt.OutputChannels
);
outputChannelRegistry.registerChannel(
	'search',
	nls.localize('searchOutputChannelTitle', 'Search')
);
