...
class UnsupportedWorkspaceSettingsContribution
	...
	constructor(
		...
		private workspaceConfigurationService: IWorkspaceConfigurationService,
		...
		this.toDispose.push(
			this.workspaceConfigurationService.onDidUpdateConfiguration(e =>
	...
	private hasShownWarning(): boolean {
		return this.storageService.getBoolean(
			UnsupportedWorkspaceSettingsContribution.storageKey,
	...
	private showWarning(unsupportedKeys: string[]): void {
		...
		const openWorkspaceSettings = new Action(
			'unsupportedWorkspaceSettings.openWorkspaceSettings',
			nls.localize('openWorkspaceSettings', 'Open Workspace Settings'),
			'',
			true,
			() => {
		...
		const openDocumentation = new Action(
			'unsupportedWorkspaceSettings.openDocumentation',
		...
		const close = new Action(
			'unsupportedWorkspaceSettings.Ignore',
			nls.localize('ignore', 'Ignore'),
			'',
			true,
			() => {
				this.telemetryService.publicLog(
