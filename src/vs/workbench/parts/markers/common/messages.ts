...
export default class Messages {
	public static MARKERS_PANEL_VIEW_CATEGORY: string = nls.localize(
		'viewCategory',
		'View'
	);
	public static MARKERS_PANEL_TOGGLE_LABEL: string = nls.localize(
	...
	public static PROBLEMS_PANEL_CONFIGURATION_AUTO_REVEAL: string = nls.localize(
		'problems.panel.configuration.autoreveal',
		'Controls if Problems view should automatically reveal files when opening them'
	);

	public static MARKERS_PANEL_TITLE_PROBLEMS: string = nls.localize(
		'markers.panel.title.problems',
		'Problems'
	);
	public static MARKERS_PANEL_ARIA_LABEL_PROBLEMS_TREE: string = nls.localize(
	...
	public static MARKERS_PANEL_MULTIPLE_ERRORS_LABEL = (
		noOfErrors: number
	): string => {
		return nls.localize(
	...
	public static MARKERS_PANEL_MULTIPLE_WARNINGS_LABEL = (
		noOfWarnings: number
	): string => {
		return nls.localize(
	...
	public static MARKERS_PANEL_MULTIPLE_INFOS_LABEL = (
		noOfInfos: number
	): string => {
		return nls.localize(
	...
	public static MARKERS_PANEL_MULTIPLE_UNKNOWNS_LABEL = (
		noOfUnknowns: number
	): string => {
		return nls.localize(
	...
	public static MARKERS_PANEL_AT_LINE_COL_NUMBER = (
		ln: number,
		col: number
	): string => {
		return nls.localize(
	...
	public static MARKERS_TREE_ARIA_LABEL_RESOURCE = (
		fileName,
		noOfProblems
	): string => {
		return nls.localize(
