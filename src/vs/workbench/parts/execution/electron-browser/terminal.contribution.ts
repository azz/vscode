...
export class OpenConsoleAction extends Action {
	...
	public static Label = baseplatform.isWindows
		? nls.localize('globalConsoleActionWin', 'Open New Command Prompt')
		: nls.localize('globalConsoleActionMacLinux', 'Open New Terminal');
	public static ScopedLabel = baseplatform.isWindows
		? nls.localize('scopedConsoleActionWin', 'Open in Command Prompt')
	...
	public run(event?: any): TPromise<any> {
		...
		pathToOpen = this.resource
			? this.resource.fsPath
			: workspace && workspace.resource.fsPath;
...
class ExplorerViewerActionContributor extends ActionBarContributor {
	...
	public getSecondaryActions(context: any): IAction[] {
		...
		let action = this.instantiationService.createInstance(
			OpenConsoleAction,
			OpenConsoleAction.ID,
			OpenConsoleAction.ScopedLabel
		);
