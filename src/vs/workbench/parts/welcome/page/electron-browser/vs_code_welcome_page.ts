...
<div class="welcomePageContainer">
	<div class="welcomePage">
		<div class="title">
			...
			<p class="subtitle detail">${escape(
				localize('welcomePage.editingEvolved', 'Editing evolved')
			)}</p>
		</div>
		<div class="row">
			<div class="splash">
				<div class="section start">
					...
					<ul>
						...
						<li><a href="command:git.clone">${escape(
							localize(
				...
				<div class="section recent">
					<h2 class="caption">${escape(
						localize('welcomePage.recent', 'Recent')
					)}</h2>
					<ul class="list">
					...
					<p class="none detail">${escape(
						localize('welcomePage.noRecentFolders', 'No recent folders')
					)}</p>
				</div>
				...
				<p class="showOnStartup"><input type="checkbox" id="showOnStartup"> <label class="caption" for="showOnStartup">${escape(
			...
			<div class="commands">
				<div class="section customize">
					<h2 class="caption">${escape(
						localize('welcomePage.customize', 'Customize')
					)}</h2>
					<ul>
						<li class="showLanguageExtensions"><button role="group" data-href="command:workbench.extensions.action.showLanguageExtensions"><h3 class="caption">${escape(
							localize(
	...
	.replace(
		'{1}',
		`<a href="command:workbench.extensions.action.showLanguageExtensions">${escape(
			localize('welcomePage.moreExtensions', 'more')
		)}</a>`
	)}
						</span></button></li>
						<li class="showRecommendedKeymapExtensions"><button role="group" data-href="command:workbench.extensions.action.showRecommendedKeymapExtensions"><h3 class="caption">${escape(
							localize(
	...
	.replace(
		'{1}',
		`<a href="command:workbench.extensions.action.showRecommendedKeymapExtensions">${escape(
			localize('welcomePage.others', 'others')
		)}</a>`
	)}
						</span></button></li>
						<li class="selectTheme"><button data-href="command:workbench.action.selectTheme"><h3 class="caption">${escape(
							localize('welcomePage.colorTheme', 'Color theme')
						)}</h3> <span class="detail">${escape(
	localize(
		...
		'Make the editor and your code look the way you love'
				...
				<div class="section learn">
					...
					<ul>
						<li class="showCommands"><button data-href="command:workbench.action.showCommands"><h3 class="caption">${escape(
	...
	'<span class="shortcut" data-command="workbench.action.showCommands"></span>'
						...
						<li class="showInterfaceOverview"><button data-href="command:workbench.action.showInterfaceOverview"><h3 class="caption">${escape(
	...
	localize(
		...
		'Get a visual overlay highlighting the major components of the UI'
						...
						<li class="showInteractivePlayground"><button data-href="command:workbench.action.showInteractivePlayground"><h3 class="caption">${escape(
							localize(
	...
	localize(
		...
		'Try essential editor features out in a short walkthrough'
				...
				<div class="section quickLinks">
					<h2 class="caption">${escape(
						localize('welcomePage.quickLinks', 'Quick links')
					)}</h2>
					<ul>
						<li class="keybindingsReference"><button data-href="command:workbench.action.keybindingsReference"><h3 class="caption">${escape(
							localize(
	...
	localize(
		...
		'A printable PDF with the most common keyboard shortcuts'
						...
						<li class="openGlobalSettings"><button data-href="command:workbench.action.openGlobalSettings"><h3 class="caption">${escape(
							localize('welcomePage.configureSettings', 'Configure settings')
						)}</h3> <span class="detail">${escape(
	localize(
