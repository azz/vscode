...
import {
	...
	Extensions as WorkbenchActionRegistryExtensions
...
import {
	...
	CallStackView,
	BreakpointsView
} from 'vs/workbench/parts/debug/electron-browser/debugViews';
import {
...
const registry = Registry.as<IWorkbenchActionRegistry>(
	WorkbenchActionRegistryExtensions.WorkbenchActions
);
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		OpenDebugPanelAction,
		OpenDebugPanelAction.ID,
		OpenDebugPanelAction.LABEL,
		openPanelKb
	),
	'View: Debug Console',
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		...
		OpenDebugViewletAction.ID,
		OpenDebugViewletAction.LABEL,
		openViewletKb
	),
	'View: Show Debug',
	nls.localize('view', 'View')
...
).registerWorkbenchContribution(DebugEditorModelManager);
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench
).registerWorkbenchContribution(DebugActionsWidget);
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench
).registerWorkbenchContribution(DebugContentProvider);
Registry.as<IWorkbenchContributionsRegistry>(
	WorkbenchExtensions.Workbench
).registerWorkbenchContribution(StatusBarColorProvider);
...
registry.registerWorkbenchAction(
	new SyncActionDescriptor(
		SelectAndStartAction,
		SelectAndStartAction.ID,
		SelectAndStartAction.LABEL
	),
...
// Register Quick Open
(<IQuickOpenRegistry>Registry.as(
