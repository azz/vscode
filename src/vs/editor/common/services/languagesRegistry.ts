...
export class LanguagesRegistry {
	...
	private static _mergeLanguage(
		...
		if (
			typeof lang.mimetypes !== 'undefined' &&
			Array.isArray(lang.mimetypes)
		) {
	...
	public getModeIdsFromFilenameOrFirstLine(
		filename: string,
		firstLine?: string
	): string[] {
