...
export class EditorModesRegistry {
	...
	private _onDidAddLanguages: Emitter<ILanguageExtensionPoint[]> = new Emitter<
		ILanguageExtensionPoint[]
	>();
	public onDidAddLanguages: Event<ILanguageExtensionPoint[]> = this
		._onDidAddLanguages.event;
...
export const PLAINTEXT_LANGUAGE_IDENTIFIER = new LanguageIdentifier(
	PLAINTEXT_MODE_ID,
