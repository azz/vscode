...
export interface MockCodeEditorCreationOptions
	extends editorOptions.IEditorOptions {
	/**
...
export function withMockCodeEditor(
	text: string[],
	options: MockCodeEditorCreationOptions,
...
function _mockCodeEditor(
	...
	let editor = new MockCodeEditor(
		new MockScopeLocation(),
		options,
