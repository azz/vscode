...
suite('Editor ViewLayout - ViewLineParts', () => {
	...
	test('ViewLineParts', () => {
		assert.deepEqual(
			...
			[new DecorationSegment(0, 0, 'c1'), new DecorationSegment(2, 2, 'c2')]
		);
		...
		assert.deepEqual(
			...
			[new DecorationSegment(0, 1, 'c1'), new DecorationSegment(2, 2, 'c2')]
		);
		...
		assert.deepEqual(
			...
			[new DecorationSegment(0, 1, 'c1'), new DecorationSegment(2, 2, 'c1 c2')]
		);
