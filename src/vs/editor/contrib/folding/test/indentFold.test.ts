...
suite('Indentation Folding', () => {
	...
	test('Limit By indent', () => {
		...
		assert.deepEqual(limitByIndent(ranges, 8), [
			r(1, 4, 0),
			r(3, 4, 2),
			r(5, 8, 0),
			r(6, 7, 1),
		...
		assert.deepEqual(limitByIndent(ranges, 7), [
			r(1, 4, 0),
			r(3, 4, 2),
			r(5, 8, 0),
			r(6, 7, 1),
		...
		assert.deepEqual(limitByIndent(ranges, 6), [
			r(1, 4, 0),
			r(3, 4, 2),
			r(5, 8, 0),
			r(6, 7, 1),
		...
		assert.deepEqual(limitByIndent(ranges, 5), [
			r(1, 4, 0),
			r(3, 4, 2),
			r(5, 8, 0),
			r(6, 7, 1),
		...
		assert.deepEqual(limitByIndent(ranges, 4), [
			r(1, 4, 0),
			r(5, 8, 0),
			r(6, 7, 1),
			r(9, 15, 0)
		]);
		assert.deepEqual(limitByIndent(ranges, 3), [
			r(1, 4, 0),
			r(5, 8, 0),
			r(9, 15, 0)
		]);
