...
function testCopyLinesDownCommand(
	...
	testCommand(
		...
		null,
		selection,
		sel => new CopyLinesCommand(sel, true),
		expectedLines,
		expectedSelection
	);
}
...
function testCopyLinesUpCommand(
	...
	testCommand(
		...
		null,
		selection,
		sel => new CopyLinesCommand(sel, false),
		expectedLines,
		expectedSelection
	);
}
...
suite('Editor Contrib - Copy Lines Command', () => {
	test('copy first line down', function() {
		testCopyLinesDownCommand(
			...
			['first', 'first', 'second line', 'third line', 'fourth line', 'fifth'],
	...
	test('copy last line down', function() {
		testCopyLinesDownCommand(
			...
			['first', 'second line', 'third line', 'fourth line', 'fifth', 'fifth'],
