...
function testBlockCommentCommand(
	lines: string[],
	selection: Selection,
	...
	testCommand(
		...
		selection,
		sel => new BlockCommentCommand(sel),
		expectedLines,
		expectedSelection
	);
	mode.dispose();
...
suite('Editor Contrib - Block Comment Command', () => {
	test('empty selection wraps itself', function() {
		testBlockCommentCommand(
			...
			['fi<00>rst', '\tsecond line', 'third line', 'fourth line', 'fifth'],
	...
	test('invisible selection ignored', function() {
		testBlockCommentCommand(
			...
			['<0first', '0>\tsecond line', 'third line', 'fourth line', 'fifth'],
	...
	test('bug9511', function() {
		testBlockCommentCommand(
			...
			['<0first0>', '\tsecond line', 'third line', 'fourth line', 'fifth'],
	...
	test('one line selection', function() {
		testBlockCommentCommand(
			...
			['fi<0rst0>', '\tsecond line', 'third line', 'fourth line', 'fifth'],
	...
	test('multi line selection', function() {
		testBlockCommentCommand(
			...
			['<0first', '\tse0>cond line', 'third line', 'fourth line', 'fifth'],
