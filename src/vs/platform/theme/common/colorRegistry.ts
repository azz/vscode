...
const colorPatternErrorMessage = nls.localize(
	'invalid.color',
...
class ColorRegistry implements IColorRegistry {
	...
	private colorSchema: IJSONSchema = {
		type: 'object',
		description: nls.localize('schema.colors', 'Colors used in the workbench.'),
		properties: {},
	...
	public registerColor(
		...
		this.colorSchema.properties[id] = {
			...
			patternErrorMessage: colorPatternErrorMessage
		};
		return id;
	}
...
export const foreground = registerColor(
	'foreground',
	{ dark: '#CCCCCC', light: '#6C6C6C', hc: '#FFFFFF' },
	nls.localize(
		'foreground',
...
export const descriptionForeground = registerColor(
	...
	{
		light: transparent(foreground, 0.7),
...
export const focusBorder = registerColor(
	'focusBorder',
	{
		dark: Color.fromHex('#0E639C').transparent(0.6),
...
export const textLinkForeground = registerColor(
	'textLink.foreground',
	{ light: '#4080D0', dark: '#4080D0', hc: '#4080D0' },
...
export const inputActiveOptionBorder = registerColor(
	...
	{ dark: '#007ACC', light: '#007ACC', hc: activeContrastBorder },
	nls.localize(
...
export const listFocusBackground = registerColor(
	...
	{ dark: '#073655', light: '#DCEBFC', hc: null },
	nls.localize(
		'listFocusBackground',
...
export const listActiveSelectionBackground = registerColor(
	...
	{ dark: '#094771', light: '#3399FF', hc: null },
	nls.localize(
...
export const listInactiveSelectionBackground = registerColor(
	...
	{ dark: '#3F3F46', light: '#CCCEDB', hc: null },
	nls.localize(
...
export const listHighlightForeground = registerColor(
	...
	{ dark: '#0097fb', light: '#007acc', hc: focusBorder },
	nls.localize(
		'highlight',
...
export const pickerGroupForeground = registerColor(
	...
	{
		dark: Color.fromHex('#0097FB').transparent(0.6),
...
export const badgeBackground = registerColor(
	'badge.background',
	{ dark: '#4D4D4D', light: '#BEBEBE', hc: Color.black },
	nls.localize(
		'badgeBackground',
...
export const scrollbarSliderBackground = registerColor(
	...
	nls.localize('scrollbarSliderBackground', 'Slider background color.')
);
...
export const editorWidgetBackground = registerColor(
	...
	{ dark: '#2D2D30', light: '#EFEFF2', hc: '#0C141F' },
	nls.localize(
 ...
 */
export const editorSelection = registerColor(
	'editor.selectionBackground',
	{ light: '#ADD6FF', dark: '#264F78', hc: '#f3f518' },
	nls.localize('editorSelection', 'Color of the editor selection.')
);
export const editorInactiveSelection = registerColor(
	'editor.inactiveSelectionBackground',
	{
		light: transparent(editorSelection, 0.5),
		dark: transparent(editorSelection, 0.5),
		hc: null
	},
	nls.localize(
...
export const editorSelectionHighlight = registerColor(
	...
	{
		light: lessProminent(editorSelection, editorBackground, 0.3, 0.6),
		dark: lessProminent(editorSelection, editorBackground, 0.3, 0.6),
		hc: null
	},
	nls.localize(
...
export const editorFindMatchHighlight = registerColor(
	...
	nls.localize('findMatchHighlight', 'Color of the other search matches.')
);
export const editorFindRangeHighlight = registerColor(
	'editor.findRangeHighlightBackground',
	{ dark: '#3a3d4166', light: '#b4b4b44d', hc: null },
	nls.localize('findRangeHighlight', 'Color the range limiting the search.')
);
 ...
 * Diff Editor Colors
 */
export const defaultInsertColor = Color.fromRGBA(
	new RGBA(155, 185, 85, 255 * 0.2)
);
export const defaultRemoveColor = Color.fromRGBA(
	new RGBA(255, 0, 0, 255 * 0.2)
);
...
const currentBaseColor = Color.fromHex('#40C8AE').transparent(
	headerTransparency
);
const incomingBaseColor = Color.fromHex('#40A6FF').transparent(
	headerTransparency
);
		...
		if (from) {
			...
			if (backgroundColor) {
				if (from.isDarkerThan(backgroundColor)) {
					return Color.getLighterColor(
						from,
						backgroundColor,
						factor
					).transparent(transparency);
				}
				return Color.getDarkerColor(from, backgroundColor, factor).transparent(
					transparency
				);
			}
