...
const schemaRegistry = <IJSONContributionRegistry>Registry.as(
...
export class ExtensionsRegistryImpl {
	...
	public registerExtensionPoint<T>(
	...
	public getExtensionPoints(): ExtensionPoint<any>[] {
		return Object.keys(this._extensionPoints).map(
			point => this._extensionPoints[point]
		);
	}
}
