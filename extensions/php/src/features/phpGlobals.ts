...
export var globalfunctions: IEntries = {
	...
	password_hash: {
		...
		signature:
			'( string $password , integer $algo [, array $options ] ): string'
	},
	password_needs_rehash: {
		description:
			'Checks if the given hash matches the given options. (5.5 only)',
	...
	http_response_code: {
		description:
			'If you pass no parameters then http_response_code will get the current status code. If you pass a parameter it will set the response code. (5.4 only)',
	...
	socket_import_stream: {
		description:
			'Imports a stream that encapsulates a socket into a socket extension resource. (5.4 only)',
	...
	header_register_callback: {
		description:
			'Registers a function that will be called when PHP starts sending output.  The callback is executed just after PHP prepares all headers to be sent, and before any other output is sent, creating a window to manipulate the outgoing headers before being sent. (5.4 only)',
		signature: '( callable $callback ): bool'
	},
	class_uses: {
		description:
			'Returns an array with the names of the traits that the given class uses. This does however not include any traits used by a parent class. (5.4 only)',
	...
	session_register_shutdown: {
		description:
			'Registers session_write_close() as a shutdown function. (5.4 only)',
		signature: '( void ): void'
	},
	mysqli_error_list: {
		description:
			'Returns a array of errors for the most recent MySQLi function call that can succeed or fail. (5.4 only)',
		signature: '( mysqli $link ): array'
	},
	mysqli_stmt_error_list: {
		description:
			'Returns an array of errors for the most recently invoked statement function that can succeed or fail. (5.4 only)',
	...
	zlib_encode: {
		...
		signature:
			'( string $data , string $encoding [, string $level = -1 ] ): string'
	},
	zend_version: {
		description:
	...
	get_required_files: {
		description:
			'Alias of get_included_files get_magic_quotes_runtime getenv PHP Options/Info Functions PHP Manual get_required_files (PHP 4, PHP 5)'
	},
	is_subclass_of: {
		description:
	...
	user_error: {
		description:
			'Alias of trigger_error trigger_error htscanner Error Handling Functions PHP Manual user_error (PHP 4, PHP 5)'
	},
	set_error_handler: {
		description:
			'Sets a user function (error_handler) to handle errors in a script.',
		signature:
			'(callback $error_handler [, int $error_types = E_ALL | E_STRICT ]): mixed'
	},
	...
	bcadd: {
		...
		signature:
			'(string $left_operand , string $right_operand [, int $scale ]): string'
	},
	bcsub: {
	...
	bccomp: {
		...
		signature:
			'(string $left_operand , string $right_operand [, int $scale ]): int'
	},
	bcpowmod: {
		description:
			'Use the fast-exponentiation method to raise left_operand to the power right_operand with respect to the modulus modulus.',
		signature:
			'(string $left_operand , string $right_operand , string $modulus [, int $scale ]): string'
	},
	jdtogregorian: {
		description:
	...
	date_create: {
		description:
			'Alias of DateTime::__construct date_create_from_format date_date_set Date/Time Functions PHP Manual date_create (PHP 5 >= 5.2.0)'
	},
	date_create_from_format: {
		description:
			'Alias of DateTime::createFromFormat date_add date_create Date/Time Functions PHP Manual date_create_from_format (PHP 5 >= 5.3.0)'
	},
	date_parse: {
	...
	date_get_last_errors: {
		description:
			'Alias of DateTime::getLastErrors date_format date_interval_create_from_date_string Date/Time Functions PHP Manual date_get_last_errors (PHP 5 >= 5.3.0)'
	},
	date_format: {
		description:
			'Alias of DateTime::format date_diff date_get_last_errors Date/Time Functions PHP Manual date_format (PHP 5 >= 5.2.0)'
	},
	date_modify: {
		description:
			'Alias of DateTime::modify date_isodate_set date_offset_get Date/Time Functions PHP Manual date_modify (PHP 5 >= 5.2.0)'
	},
	date_add: {
		description:
			'Alias of DateTime::add checkdate date_create_from_format Date/Time Functions PHP Manual date_add (PHP 5 >= 5.3.0)'
	},
	date_sub: {
		description:
			'Alias of DateTime::sub date_parse date_sun_info Date/Time Functions PHP Manual date_sub (PHP 5 >= 5.3.0)'
	},
	date_timezone_get: {
		description:
			'Alias of DateTime::getTimezone date_timestamp_set date_timezone_set Date/Time Functions PHP Manual date_timezone_get (PHP 5 >= 5.2.0)'
	},
	date_timezone_set: {
		description:
			'Alias of DateTime::setTimezone date_timezone_get date Date/Time Functions PHP Manual date_timezone_set (PHP 5 >= 5.2.0)'
	},
	date_offset_get: {
		description:
			'Alias of DateTime::getOffset date_modify date_parse_from_format Date/Time Functions PHP Manual date_offset_get (PHP 5 >= 5.2.0)'
	},
	date_diff: {
		description:
			'Alias of DateTime::diff date_default_timezone_set date_format Date/Time Functions PHP Manual date_diff (PHP 5 >= 5.3.0)'
	},
	date_time_set: {
		description:
			'Alias of DateTime::setTime date_sunset date_timestamp_get Date/Time Functions PHP Manual date_time_set (PHP 5 >= 5.2.0)'
	},
	date_date_set: {
		description:
			'Alias of DateTime::setDate date_create date_default_timezone_get Date/Time Functions PHP Manual date_date_set (PHP 5 >= 5.2.0)'
	},
	date_isodate_set: {
		description:
			'Alias of DateTime::setISODate date_interval_format date_modify Date/Time Functions PHP Manual date_isodate_set (PHP 5 >= 5.2.0)'
	},
	date_timestamp_set: {
		description:
			'Alias of DateTime::setTimestamp date_timestamp_get date_timezone_get Date/Time Functions PHP Manual date_timestamp_set (PHP 5 >= 5.3.0)'
	},
	date_timestamp_get: {
		description:
			'Alias of DateTime::getTimestamp date_time_set date_timestamp_set Date/Time Functions PHP Manual date_timestamp_get (PHP 5 >= 5.3.0)'
	},
	timezone_open: {
		description:
			'Alias of DateTimeZone::__construct timezone_offset_get timezone_transitions_get Date/Time Functions PHP Manual timezone_open (PHP 5 >= 5.2.0)'
	},
	timezone_name_get: {
		description:
			'Alias of DateTimeZone::getName timezone_name_from_abbr timezone_offset_get Date/Time Functions PHP Manual timezone_name_get (PHP 5 >= 5.2.0)'
	},
	...
	timezone_offset_get: {
		description:
			'Alias of DateTimeZone::getOffset timezone_name_get timezone_open Date/Time Functions PHP Manual timezone_offset_get (PHP 5 >= 5.2.0)'
	},
	timezone_transitions_get: {
		description:
			'Alias of DateTimeZone::getTransitions timezone_open timezone_version_get Date/Time Functions PHP Manual timezone_transitions_get (PHP 5 >= 5.2.0)'
	},
	timezone_location_get: {
		description:
			'Alias of DateTimeZone::getLocation timezone_identifiers_list timezone_name_from_abbr Date/Time Functions PHP Manual timezone_location_get (PHP 5 >= 5.3.0)'
	},
	timezone_identifiers_list: {
		description:
			'Alias of DateTimeZone::listIdentifiers timezone_abbreviations_list timezone_location_get Date/Time Functions PHP Manual timezone_identifiers_list (PHP 5 >= 5.2.0)'
	},
	timezone_abbreviations_list: {
		description:
			'Alias of DateTimeZone::listAbbreviations time timezone_identifiers_list Date/Time Functions PHP Manual timezone_abbreviations_list (PHP 5 >= 5.2.0)'
	},
	...
	date_interval_create_from_date_string: {
		description:
			'Alias of DateInterval::createFromDateString date_get_last_errors date_interval_format Date/Time Functions PHP Manual date_interval_create_from_date_string (PHP 5 >= 5.3.0)'
	},
	date_interval_format: {
		description:
			'Alias of DateInterval::format date_interval_create_from_date_string date_isodate_set Date/Time Functions PHP Manual date_interval_format (PHP 5 >= 5.3.0)'
	},
	...
	filter_input: {
		description:
			'Parameters type One of INPUT_GET, INPUT_POST, INPUT_COOKIE, INPUT_SERVER, or INPUT_ENV.',
		signature:
	...
	filter_list: {
		description:
			'Return Values Returns an array of names of all supported filters, empty array if there are no such filters. Indexes of this array are not filter IDs, they can be obtained with filter_id() from a name instead.',
		signature: '(void): array'
	},
	filter_has_var: {
		description:
	...
	ftp_nlist: {
		description:
			'Parameters ftp_stream The link identifier of the FTP connection.',
	...
	ftp_get: {
		...
		signature:
			'(resource $ftp_stream , string $local_file , string $remote_file , int $mode [, int $resumepos = 0 ]): bool'
	},
	ftp_fget: {
		description:
			'ftp_fget() retrieves remote_file from the FTP server, and writes it to the given file pointer.',
		signature:
			'(resource $ftp_stream , resource $handle , string $remote_file , int $mode [, int $resumepos = 0 ]): bool'
	},
	ftp_put: {
	...
	ftp_fput: {
		...
		signature:
			'(resource $ftp_stream , string $remote_file , resource $handle , int $mode [, int $startpos = 0 ]): bool'
	},
	ftp_size: {
	...
	ftp_nb_fget: {
		...
		signature:
			'(resource $ftp_stream , resource $handle , string $remote_file , int $mode [, int $resumepos = 0 ]): int'
	},
	ftp_nb_get: {
		description:
			'ftp_nb_get() retrieves a remote file from the FTP server, and saves it into a local file.',
		signature:
			'(resource $ftp_stream , string $local_file , string $remote_file , int $mode [, int $resumepos = 0 ]): int'
	},
	ftp_nb_continue: {
	...
	ftp_nb_put: {
		...
		signature:
			'(resource $ftp_stream , string $remote_file , string $local_file , int $mode [, int $startpos = 0 ]): int'
	},
	ftp_nb_fput: {
		description:
			'ftp_nb_fput() uploads the data from a file pointer to a remote file on the FTP server.',
		signature:
			'(resource $ftp_stream , string $remote_file , resource $handle , int $mode [, int $startpos = 0 ]): int'
	},
	ftp_quit: {
		description:
			'Alias of ftp_close ftp_pwd ftp_raw FTP Functions PHP Manual ftp_quit (PHP 4, PHP 5)'
	},
	hash: {
		description:
			'Parameters algo Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)',
		signature:
	...
	hash_hmac: {
		description:
			'Parameters algo Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..) See hash_algos() for a list of supported algorithms.',
		signature:
	...
	hash_init: {
		description:
			'Parameters algo Name of selected hashing algorithm (i.e. "md5", "sha256", "haval160,4", etc..)',
		signature:
			'(string $algo [, int $options = 0 [, string $key = NULL ]]): resource'
	},
	hash_update: {
	...
	hash_update_stream: {
		description: 'Parameters context Hashing context returned by hash_init().',
		signature:
			'(resource $context , resource $handle [, int $length = -1 ]): int'
	},
	hash_update_file: {
		description: 'Parameters context Hashing context returned by hash_init().',
		signature:
			'(resource $context , string $filename [, resource $context = NULL ]): bool'
	},
	hash_final: {
		description: 'Parameters context Hashing context returned by hash_init().',
	...
	hash_algos: {
		description:
			'Return Values Returns a numerically indexed array containing the list of supported hashing algorithms.',
		signature: '(void): array'
	},
	mhash_keygen_s2k: {
		description:
	...
	iconv_mime_encode: {
		description:
			'Composes and returns a string that represents a valid MIME header field, which looks like the following: Subject: =?ISO-8859-1?Q?Pr=FCfung_f=FCr?= Entwerfen von einer MIME kopfzeile In the above example, "Subject" is the field name and the portion that begins with "=?ISO-8859-1?..." is the field value.',
		signature:
	...
	mcrypt_generic_end: {
		description:
			'Warning This function is deprecated, use mcrypt_generic_deinit() instead. It can cause crashes when used with mcrypt_module_close() due to multiple buffer frees.',
	...
	odbc_specialcolumns: {
		...
		signature:
			'(resource $connection_id , int $type , string $qualifier , string $owner , string $table , int $scope , int $nullable): resource'
	},
	odbc_statistics: {
	...
	odbc_do: {
		description:
			'Alias of odbc_exec odbc_data_source odbc_error ODBC Functions PHP Manual odbc_do (PHP 4, PHP 5)'
	},
	odbc_field_precision: {
		description:
			'Alias of odbc_field_len odbc_field_num odbc_field_scale ODBC Functions PHP Manual odbc_field_precision (PHP 4, PHP 5)'
	},
	preg_match: {
		description:
	...
	preg_replace_callback: {
		...
		signature:
			'(mixed $pattern , callback $callback , mixed $subject [, int $limit = -1 [, int &$count ]]): mixed'
	},
	preg_filter: {
		description:
	...
	session_set_save_handler: {
		...
		signature:
			'(callback $open , callback $close , callback $read , callback $write , callback $destroy , callback $gc): bool'
	},
	...
	session_set_cookie_params: {
		...
		signature:
			'(int $lifetime [, string $path [, string $domain [, bool $secure = false [, bool $httponly = false ]]]]): void'
	},
	...
	session_commit: {
		description:
			'Alias of session_write_close session_cache_limiter session_decode Session Functions PHP Manual session_commit (PHP 4 >= 4.4.0, PHP 5)'
	},
	spl_classes: {
		description:
	...
	spl_autoload_register: {
		...
		signature:
			'([ callback $autoload_function [, bool $throw = true [, bool $prepend = false ]]]): bool'
	},
	...
	iterator_apply: {
		...
		signature:
			'(Traversable $iterator , callback $function [, array $args ]): int'
	},
	constant: {
	...
	htmlspecialchars: {
		...
		signature:
			'(string $string [, int $flags = ENT_COMPAT [, string $charset [, bool $double_encode = true ]]]): string'
	},
	htmlentities: {
		description:
	...
	html_entity_decode: {
		...
		signature:
			"(string $string [, int $quote_style = ENT_COMPAT [, string $charset = 'UTF-8' ]]): string"
	},
	...
	get_html_translation_table: {
		...
		signature:
			'([ int $table = HTML_SPECIALCHARS [, int $quote_style = ENT_COMPAT [, string $charset_hint ]]]): array'
	},
	sha1: {
		description:
	...
	iptcembed: {
		...
		signature:
			'(string $iptcdata , string $jpeg_file_name [, int $spool ]): mixed'
	},
	getimagesize: {
		description:
	...
	strcspn: {
		...
		signature:
			'(string $str1 , string $str2 [, int $start [, int $length ]]): int'
	},
	strtok: {
		description:
	...
	join: {
		description:
			'Alias of implode implode lcfirst String Functions PHP Manual join (PHP 4, PHP 5)'
	},
	setlocale: {
	...
	chop: {
		description:
			'Alias of rtrim bin2hex chr String Functions PHP Manual chop (PHP 4, PHP 5)'
	},
	strchr: {
		description:
			'Alias of strstr strcasecmp strcmp String Functions PHP Manual strchr (PHP 4, PHP 5)'
	},
	sprintf: {
		description:
	...
	magic_quotes_runtime: {
		description:
			'Alias of set_magic_quotes_runtime ini_set main PHP Options/Info Functions PHP Manual magic_quotes_runtime (PHP 4, PHP 5)'
	},
	...
	call_user_func: {
		...
		signature:
			'(callback $function [, mixed $parameter [, mixed $... ]]): mixed'
	},
	...
	show_source: {
		description:
			'Alias of highlight_file php_strip_whitespace sleep Misc. Functions PHP Manual show_source (PHP 4, PHP 5)'
	},
	highlight_string: {
		description:
	...
	ini_alter: {
		description:
			'Alias of ini_set getrusage ini_get_all PHP Options/Info Functions PHP Manual ini_alter (PHP 4, PHP 5)'
	},
	ini_restore: {
	...
	header: {
		...
		signature:
			'(string $string [, bool $replace = true [, int $http_response_code ]]): void'
	},
	header_remove: {
	...
	dns_check_record: {
		description:
			'Alias of checkdnsrr define_syslog_variables dns_get_mx Network Functions PHP Manual dns_check_record (PHP 5)'
	},
	checkdnsrr: {
	...
	dns_get_mx: {
		description:
			'Alias of getmxrr dns_check_record dns_get_record Network Functions PHP Manual dns_get_mx (PHP 5)'
	},
	getmxrr: {
	...
	dns_get_record: {
		...
		signature:
			'(string $hostname [, int $type = DNS_ANY [, array &$authns [, array &$addtl ]]]): array'
	},
	intval: {
		description:
	...
	doubleval: {
		description:
			'Alias of floatval debug_zval_dump empty Variable handling Functions PHP Manual doubleval (PHP 4, PHP 5)'
	},
	strval: {
		description:
	...
	is_long: {
		description:
			'Alias of is_int is_integer is_null Variable handling Functions PHP Manual is_long (PHP 4, PHP 5)'
	},
	is_float: {
	...
	is_integer: {
		description:
			'Alias of is_int is_int is_long Variable handling Functions PHP Manual is_integer (PHP 4, PHP 5)'
	},
	is_double: {
		description:
			'Alias of is_float is_callable is_float Variable handling Functions PHP Manual is_double (PHP 4, PHP 5)'
	},
	is_real: {
		description:
			'Alias of is_float is_object is_resource Variable handling Functions PHP Manual is_real (PHP 4, PHP 5)'
	},
	is_numeric: {
		description:
	...
	is_callable: {
		...
		signature:
			'(callback $name [, bool $syntax_only = false [, string &$callable_name ]]): bool'
	},
	pclose: {
	...
	fputs: {
		description:
			'Alias of fwrite fputcsv fread Filesystem Functions PHP Manual fputs (PHP 4, PHP 5)'
	},
	mkdir: {
	...
	file_get_contents: {
		...
		signature:
			'(string $filename [, bool $use_include_path = false [, resource $context [, int $offset = -1 [, int $maxlen ]]]]): string'
	},
	file_put_contents: {
		description:
	...
	fputcsv: {
		...
		signature:
			"(resource $handle , array $fields [, string $delimiter = ',' [, string $enclosure = '\"' ]]): int"
	},
	flock: {
		description:
	...
	set_file_buffer: {
		description:
			'Alias of stream_set_write_buffer rmdir stat Filesystem Functions PHP Manual set_file_buffer (PHP 4, PHP 5)'
	},
	set_socket_blocking: {
		description:
			'Alias of stream_set_blocking Stream Functions stream_bucket_append Stream Functions PHP Manual set_socket_blocking (PHP 4, PHP 5)'
	},
	stream_set_blocking: {
	...
	socket_set_blocking: {
		description:
			'Alias of stream_set_blocking socket_get_status socket_set_timeout Network Functions PHP Manual socket_set_blocking (PHP 4, PHP 5)'
	},
	...
	stream_register_wrapper: {
		description:
			'Alias of stream_wrapper_register stream_notification_callback stream_resolve_include_path Stream Functions PHP Manual stream_register_wrapper (PHP 4 >= 4.3.0, PHP 5)'
	},
	...
	socket_set_timeout: {
		description:
			'Alias of stream_set_timeout socket_set_blocking syslog Network Functions PHP Manual socket_set_timeout (PHP 4, PHP 5)'
	},
	socket_get_status: {
		description:
			'Alias of stream_get_meta_data setrawcookie socket_set_blocking Network Functions PHP Manual socket_get_status (PHP 4, PHP 5)'
	},
	realpath: {
		description:
	...
	scandir: {
		...
		signature:
			'(string $directory [, int $sorting_order = 0 [, resource $context ]]): array'
	},
	glob: {
		description:
	...
	is_writeable: {
		description:
			'Alias of is_writable is_writable lchgrp Filesystem Functions PHP Manual is_writeable (PHP 4, PHP 5)'
	},
	is_readable: {
	...
	diskfreespace: {
		description:
			'Alias of disk_free_space disk_total_space fclose Filesystem Functions PHP Manual diskfreespace (PHP 4, PHP 5)'
	},
	mail: {
		description: 'Sends an email.',
		signature:
			'(string $to , string $subject , string $message [, string $additional_headers [, string $additional_parameters ]]): bool'
	},
	ezmlm_hash: {
		description:
	...
	ob_start: {
		...
		signature:
			'([ callback $output_callback [, int $chunk_size = 0 [, bool $erase = true ]]]): bool'
	},
	ob_flush: {
		description:
	...
	extract: {
		...
		signature:
			'(array &$var_array [, int $extract_type = EXTR_OVERWRITE [, string $prefix ]]): int'
	},
	compact: {
	...
	array_multisort: {
		...
		signature:
			'(array &$arr [, mixed $arg = SORT_ASC [, mixed $arg = SORT_REGULAR [, mixed $... ]]]): bool'
	},
	array_push: {
		description:
			'array_push() treats array as a stack, and pushes the passed variables onto the end of array. The length of array increases by the number of variables pushed. Has the same effect as: <?php $array[] = $var;?> repeated for each var.',
	...
	array_splice: {
		...
		signature:
			'(array &$input , int $offset [, int $length = 0 [, mixed $replacement ]]): array'
	},
	array_slice: {
		description:
			'array_slice() returns the sequence of elements from the array array as specified by the offset and length parameters.',
		signature:
			'(array $array , int $offset [, int $length [, bool $preserve_keys = false ]]): array'
	},
	array_merge: {
		description:
	...
	array_keys: {
		...
		signature:
			'(array $input [, mixed $search_value [, bool $strict = false ]]): array'
	},
	array_values: {
		description:
	...
	array_reduce: {
		...
		signature:
			'(array $input , callback $function [, mixed $initial = NULL ]): mixed'
	},
	array_pad: {
		description:
	...
	array_intersect_ukey: {
		...
		signature:
			'(array $array1 , array $array2 [, array $... ], callback $key_compare_func): array'
	},
	array_uintersect: {
		description:
			'Computes the intersection of arrays, compares data by a callback function.',
		signature:
			'(array $array1 , array $array2 [, array $ ... ], callback $data_compare_func): array'
	},
	...
	array_uintersect_uassoc: {
		...
		signature:
			'(array $array1 , array $array2 [, array $ ... ], callback $data_compare_func , callback $key_compare_func): array'
	},
	array_diff: {
	...
	array_chunk: {
		...
		signature:
			'(array $input , int $size [, bool $preserve_keys = false ]): array'
	},
	array_combine: {
		description:
	...
	pos: {
		description:
			'Alias of current next prev Array Functions PHP Manual pos (PHP 4, PHP 5)'
	},
	sizeof: {
		description:
			'Alias of count shuffle sort Array Functions PHP Manual sizeof (PHP 4, PHP 5)'
	},
	assert: {
		description:
	...
	version_compare: {
		...
		signature:
			'(string $version1 , string $version2 [, string $operator ]): mixed'
	},
	str_rot13: {
		description:
	...
	gzputs: {
		description:
			'Alias of gzwrite gzpassthru gzread Zlib Functions PHP Manual gzputs (PHP 4, PHP 5)'
	},
	gzfile: {
		description:
	...
	simplexml_load_file: {
		...
		signature:
			'(string $filename [, string $class_name = "SimpleXMLElement" [, int $options = 0 [, string $ns [, bool $is_prefix = false ]]]]): object'
	},
	simplexml_load_string: {
		description: 'Takes a well-formed XML string and returns it as an object.',
		signature:
			'(string $data [, string $class_name = "SimpleXMLElement" [, int $options = 0 [, string $ns [, bool $is_prefix = false ]]]]): object'
	},
	...
	xml_set_element_handler: {
		...
		signature:
			'(resource $parser , callback $start_element_handler , callback $end_element_handler): bool'
	},
	...
	mysql_pconnect: {
		...
		signature:
			'([ string $server = ini_get("mysql.default_host") [, string $username = ini_get("mysql.default_user") [, string $password = ini_get("mysql.default_password") [, int $client_flags ]]]]): resource'
	},
	mysql_close: {
		description:
	...
	mysql_real_escape_string: {
		...
		signature:
			'(string $unescaped_string [, resource $link_identifier ]): string'
	},
	mysql_stat: {
	...
	mysqli_connect: {
		description:
			'Alias of mysqli::__construct mysqli_client_encoding mysqli_disable_reads_from_master Aliases and deprecated Mysqli Functions PHP Manual mysqli_connect (PHP 5)'
	},
	mysqli_execute: {
		description:
			'Alias for mysqli_stmt_execute mysqli_escape_string mysqli_fetch Aliases and deprecated Mysqli Functions PHP Manual mysqli_execute (PHP 5)'
	},
	mysqli_report: {
		description:
	...
	mysqli_bind_param: {
		description:
			'Alias for mysqli_stmt_bind_param Aliases and deprecated Mysqli Functions mysqli_bind_result Aliases and deprecated Mysqli Functions PHP Manual mysqli_bind_param (PHP 5)'
	},
	mysqli_bind_result: {
		description:
			'Alias for mysqli_stmt_bind_result mysqli_bind_param mysqli_client_encoding Aliases and deprecated Mysqli Functions PHP Manual mysqli_bind_result (PHP 5)'
	},
	mysqli_client_encoding: {
		description:
			'Alias of mysqli_character_set_name mysqli_bind_result mysqli_connect Aliases and deprecated Mysqli Functions PHP Manual mysqli_client_encoding (PHP 5)'
	},
	mysqli_escape_string: {
		description:
			'Alias of mysqli_real_escape_string mysqli_enable_rpl_parse mysqli_execute Aliases and deprecated Mysqli Functions PHP Manual mysqli_escape_string (PHP 5)'
	},
	mysqli_fetch: {
		description:
			'Alias for mysqli_stmt_fetch mysqli_execute mysqli_get_cache_stats Aliases and deprecated Mysqli Functions PHP Manual mysqli_fetch (PHP 5)'
	},
	mysqli_param_count: {
		description:
			'Alias for mysqli_stmt_param_count mysqli_master_query mysqli_report Aliases and deprecated Mysqli Functions PHP Manual mysqli_param_count (PHP 5)'
	},
	mysqli_get_metadata: {
		description:
			'Alias for mysqli_stmt_result_metadata mysqli_get_cache_stats mysqli_master_query Aliases and deprecated Mysqli Functions PHP Manual mysqli_get_metadata (PHP 5)'
	},
	mysqli_send_long_data: {
		description:
			'Alias for mysqli_stmt_send_long_data mysqli_rpl_query_type mysqli_send_query Aliases and deprecated Mysqli Functions PHP Manual mysqli_send_long_data (PHP 5)'
	},
	mysqli_set_opt: {
		description:
			'Alias of mysqli_options mysqli_send_query mysqli_slave_query Aliases and deprecated Mysqli Functions PHP Manual mysqli_set_opt (PHP 5)'
	},
	mb_convert_case: {
		description:
			'Performs case folding on a string, converted in the way specified by mode.',
		signature:
			'(string $str , int $mode = MB_CASE_UPPER [, string $encoding = mb_internal_encoding() ]): string'
	},
	mb_strtoupper: {
		description:
	...
	mb_strpos: {
		...
		signature:
			'(string $haystack , string $needle [, int $offset = 0 [, string $encoding ]]): int'
	},
	mb_strrpos: {
		description:
	...
	mb_stripos: {
		...
		signature:
			'(string $haystack , string $needle [, int $offset [, string $encoding ]]): int'
	},
	mb_strripos: {
		description:
	...
	mb_strstr: {
		...
		signature:
			'(string $haystack , string $needle [, bool $part = false [, string $encoding ]]): string'
	},
	mb_strrchr: {
		description:
	...
	mb_substr: {
		...
		signature:
			'(string $str , int $start [, int $length [, string $encoding ]]): string'
	},
	mb_strcut: {
		description:
	...
	mb_strimwidth: {
		...
		signature:
			'(string $str , int $start , int $width [, string $trimmarker [, string $encoding ]]): string'
	},
	mb_convert_encoding: {
		description:
			'Converts the character encoding of string str to to_encoding from optionally from_encoding.',
		signature:
			'(string $str , string $to_encoding [, mixed $from_encoding ]): string'
	},
	mb_detect_encoding: {
	...
	mb_convert_kana: {
		...
		signature:
			'(string $str [, string $option = "KV" [, string $encoding ]]): string'
	},
	...
	mb_send_mail: {
		...
		signature:
			'(string $to , string $subject , string $message [, string $additional_headers = NULL [, string $additional_parameter = NULL ]]): bool'
	},
	mb_get_info: {
		description:
	...
	imagepng: {
		...
		signature:
			'(resource $image [, string $filename [, int $quality [, int $filters ]]]): bool'
	},
	imagegif: {
		description:
	...
	imagegd2: {
		...
		signature:
			'(resource $image [, string $filename [, int $chunk_size [, int $type = IMG_GD2_RAW ]]]): bool'
	},
	imagedestroy: {
	...
	imagefttext: {
		description:
			'Parameters imageAn image resource, returned by one of the image creation functions,such as imagecreatetruecolor().',
		signature:
	...
	image2wbmp: {
		...
		signature:
			'(resource $image [, string $filename [, int $threshold ]]): bool'
	},
	imagelayereffect: {
		description:
	...
	exif_read_data: {
		...
		signature:
			'(string $filename [, string $sections = NULL [, bool $arrays = false [, bool $thumbnail = false ]]]): array'
	},
	read_exif_data: {
		description:
			'Alias of exif_read_data exif_thumbnail GD Exif Functions PHP Manual read_exif_data (PHP 4 >= 4.0.1, PHP 5)'
	},
	exif_tagname: {
		description:
			'Parameters index The Tag ID for which a Tag Name will be looked up.',
	...
	exif_thumbnail: {
		...
		signature:
			'(string $filename [, int &$width [, int &$height [, int &$imagetype ]]]): string'
	},
	exif_imagetype: {
		description:
	...
	openssl_get_privatekey: {
		description:
			'Alias of openssl_pkey_get_private openssl_get_md_methods openssl_get_publickey OpenSSL Functions PHP Manual openssl_get_privatekey (PHP 4 >= 4.0.4, PHP 5)'
	},
	openssl_get_publickey: {
		description:
			'Alias of openssl_pkey_get_public openssl_get_privatekey openssl_open OpenSSL Functions PHP Manual openssl_get_publickey (PHP 4 >= 4.0.4, PHP 5)'
	},
	openssl_x509_read: {
		description:
	...
	openssl_csr_export_to_file: {
		...
		signature:
			'(resource $csr , string $outfilename [, bool $notext = true ]): bool'
	},
	openssl_csr_sign: {
		description:
	...
	openssl_encrypt: {
		...
		signature:
			'(string $data , string $method , string $password [, bool $raw_output = false [, string $iv = "" ]]): string'
	},
	openssl_decrypt: {
		description:
			'Takes a raw or base64 encoded string and decrypts it using a given method and key.',
		signature:
			'(string $data , string $method , string $password [, bool $raw_input = false [, string $iv = "" ]]): string'
	},
	...
	openssl_sign: {
		...
		signature:
			'(string $data , string &$signature , mixed $priv_key_id [, int $signature_alg = OPENSSL_ALGO_SHA1 ]): bool'
	},
	openssl_verify: {
		description:
		...
		signature:
			'(string $data , string $signature , mixed $pub_key_id [, int $signature_alg = OPENSSL_ALGO_SHA1 ]): int'
	},
	openssl_seal: {
		description:
		...
		signature:
			'(string $data , string &$sealed_data , array &$env_keys , array $pub_key_ids [, string $method ]): int'
	},
	openssl_open: {
		description:
		...
		signature:
			'(string $sealed_data , string &$open_data , string $env_key , mixed $priv_key_id [, string $method ]): bool'
	},
	openssl_pkcs7_verify: {
		description:
			'openssl_pkcs7_verify() reads the S/MIME message contained in the given file and examines the digital signature.',
		signature:
			'(string $filename , int $flags [, string $outfilename [, array $cainfo [, string $extracerts [, string $content ]]]]): mixed'
	},
	...
	imap_open: {
		...
		signature:
			'(string $mailbox , string $username , string $password [, int $options = NIL [, int $n_retries = 0 [, array $params = NULL ]]]): resource'
	},
	imap_reopen: {
		description:
	...
	imap_sort: {
		...
		signature:
			'(resource $imap_stream , int $criteria , int $reverse [, int $options = 0 [, string $search_criteria = NULL [, string $charset = NIL ]]]): array'
	},
	imap_uid: {
		description:
	...
	imap_search: {
		...
		signature:
			'(resource $imap_stream , string $criteria [, int $options = SE_FREE [, string $charset = NIL ]]): array'
	},
	imap_utf7_decode: {
	...
	imap_header: {
		description:
			'Alias of imap_headerinfo imap_getsubscribed imap_headerinfo IMAP Functions PHP Manual imap_header (PHP 4, PHP 5)'
	},
	imap_listmailbox: {
		description:
			'Alias of imap_list imap_list imap_listscan IMAP Functions PHP Manual imap_listmailbox (PHP 4, PHP 5)'
	},
	imap_getmailboxes: {
	...
	imap_scanmailbox: {
		description:
			'Alias of imap_listscan imap_scan imap_search IMAP Functions PHP Manual imap_scanmailbox (PHP 4, PHP 5)'
	},
	imap_listsubscribed: {
		description:
			'Alias of imap_lsub imap_listscan imap_lsub IMAP Functions PHP Manual imap_listsubscribed (PHP 4, PHP 5)'
	},
	imap_getsubscribed: {
	...
	imap_fetchtext: {
		description:
			'Alias of imap_body imap_fetchstructure imap_gc IMAP Functions PHP Manual imap_fetchtext (PHP 4, PHP 5)'
	},
	imap_scan: {
		description:
			'Alias of imap_listscan imap_savebody imap_scanmailbox IMAP Functions PHP Manual imap_scan (PHP 4, PHP 5)'
	},
	imap_create: {
		description:
			'Alias of imap_createmailbox imap_close imap_createmailbox IMAP Functions PHP Manual imap_create (PHP 4, PHP 5)'
	},
	imap_rename: {
		description:
			'Alias of imap_renamemailbox imap_qprint imap_renamemailbox IMAP Functions PHP Manual imap_rename (PHP 4, PHP 5)'
	},
	tidy_get_output: {
