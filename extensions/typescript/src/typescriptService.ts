...
export interface ITypescriptServiceClient {
	...
	onProjectLanguageServiceStateChanged: Event<
	...
	onTypesInstallerInitializationFailed: Event<
	...
	execute(
		...
		args: Proto.FileLocationRequestArgs,
		token?: CancellationToken
	): Promise<Proto.OccurrencesResponse>;
	execute(
		command: 'projectInfo',
