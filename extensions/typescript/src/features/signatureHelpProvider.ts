...
export default class TypeScriptSignatureHelpProvider
	...
	public provideSignatureHelp(
		...
		return this.client.execute('signatureHelp', args, token).then(
			response => {
				...
				info.items.forEach((item, i) => {
					...
					signature.documentation = Previewer.plainDocumentation(
						item.documentation,
						item.tags
					);
